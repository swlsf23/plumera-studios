...
1. Return a complete Markdown file ready to save as
   content/es/aprender-anglais/votw/{slug}.md
...
4. Fill YAML frontmatter: title, description, slug, target, locale, level,
   author, date. Set target: aprender-anglais and locale: es.
...
target: aprender-anglais      # Idioma que se enseña
...
related:        # Tarjetas "También te puede interesar" (opcional)
  - href:       # Ruta del sitio, p. ej. /es/aprender-anglais/votw/
...
<!--
  ...
  - Copy to content/es/aprender-anglais/votw/{slug}.md
