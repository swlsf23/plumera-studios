---
title: Comment nous utilisons le CECR
...
| Niveau | En bref |
|--------|---------|
| A1 | Vous pouvez gérer des phrases simples et des besoins quotidiens de base. |
| A2 | Vous pouvez mener de courts échanges sur des sujets habituels et décrire des situations simples. |
| B1 | Vous pouvez vous débrouiller dans la plupart des situations de voyage et du quotidien, et expliquer des opinions simplement. |
| B2 | Vous pouvez suivre des textes complexes et interagir avec une certaine aisance sur de nombreux sujets. |
| C1 | Vous pouvez utiliser la langue avec souplesse dans la vie sociale, académique et professionnelle. |
| C2 | Vous pouvez presque tout comprendre et vous exprimer avec précision. |
...
- Commencez par A1 si vous débutez ou construisez encore les bases.
- Choisissez A2 lorsque les courts échanges du quotidien deviennent gérables.
- Passez à B1 lorsque vous vous en sortez dans la plupart des situations ordinaires sans changer de langue à chaque instant.
- Utilisez B2 et au-delà lorsque vous voulez de la profondeur : nuances, expressions et textes plus exigeants.

Si une page est trop difficile, descendez d’un niveau. Si elle est trop facile, essayez le niveau suivant.
