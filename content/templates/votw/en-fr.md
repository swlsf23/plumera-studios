...
1. Return a complete Markdown file ready to save as
   content/fr/aprendre-anglais/votw/{slug}.md
...
4. Fill YAML frontmatter: title, description, slug, target, locale, level,
   author, date. Set target: aprendre-anglais and locale: fr.
...
target: aprendre-anglais      # Langue enseignée
...
related:        # Cartes « Vous aimerez aussi » (optionnel)
  - href:       # Chemin du site, p. ex. /fr/aprendre-anglais/votw/
...
<!--
  ...
  - Copy to content/fr/aprendre-anglais/votw/{slug}.md
